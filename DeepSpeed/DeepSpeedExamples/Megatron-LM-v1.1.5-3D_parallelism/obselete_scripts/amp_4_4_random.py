...
from sa import generate_initial, neighbor, cool_down, candidate, enumerate_settings
...
exp_name = f"aws_4_4_{config_h}_{config_n}_rs"
...
num_threads = 1
ret = enumerate_settings(M, N, gbs=global_bs)
print(ret)
    ...
    for j in range(num_threads):
        ...
        if step is None:
            ...
            if accept:
                ...
                if new_candidate not in simulated_settings:
                    ...
                    simulated_settings.append(new_candidate) 
                    ready_data_count += 1
                    with open(record_file, "a") as fp:
