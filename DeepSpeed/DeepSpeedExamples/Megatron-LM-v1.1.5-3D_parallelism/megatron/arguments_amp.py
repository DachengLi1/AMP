...
def parse_args(extra_args_provider=None, defaults={},
    ...
    args.model_parallel_size =  args.amp_model_parallel_size # -1 #min(args.model_parallel_size, args.world_size)
    args.pipe_parallel_size = args.amp_pipe_parallel_size #-1

    if args.rank == 0:
        print('using world size: {} and model-parallel size: {} '.format(
            args.world_size, args.amp_model_parallel_size))
...
def _add_distributed_args(parser):
    ...
    group.add_argument('--amp_model-parallel-size', type=int, default=1,
                       help='Size of the model parallel.')
    group.add_argument('--amp_pipe-parallel-size', type=int, default=0,
                       help='Size of the pipeline parallel. Disable with 0.')
